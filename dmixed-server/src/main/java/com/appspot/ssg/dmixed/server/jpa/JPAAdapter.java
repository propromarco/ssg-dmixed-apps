...
public class JPAAdapter implements IJPAAdapter {
	...
	// final JPAKind k5 = new JPAKind("Antoinia",
	// Date.valueOf("2004-01-16"));
	...
	// final JPAKind k11 = new JPAKind("Johanna",
	...
	// final JPATermin t2 = createTermin(em, Date.valueOf("2013-05-05"),
	...
	try {
	    ...
	    final List<JPAMitbringsel> mitbringsel = query.getResultList();
	    if (terminCreate.isHeimspiel())
		createMitbringsel(em, termin, mitbringsel);
	    return termin;
	} finally {
	    em.close();
	}
