...
public class ClubbiertestJqm4gwt implements EntryPoint {
    ...
    public void onModuleLoad() {
        ...
        ClubbiertestDataHandler mapper = new ClubbiertestDataHandler(util, eventBus, css, texte);
        ClubbiertestMainPresenter clubbiertestMainPresenter = new ClubbiertestMainPresenter(mapper);
