...
public class ClubbiertestSidebar extends FlowPanel implements
		PlaceChangeEvent.Handler {

	private SidebarEntry kontinentEntry, laenderEntry, sortenEntry;
	private EventBus eventBus;
	private HandlerRegistration registration, kRegistration, lRegistration,
			sRegistration;
	...
	public ClubbiertestSidebar(ClubbiertestDataHandler dataHandler) {
		...
		kontinentEntry = new SidebarEntry(dataHandler, "Kontinente",
				Sidebars.Kontinente);
		laenderEntry = new SidebarEntry(dataHandler, "L&auml;nder",
				Sidebars.Laender);
	...
	protected void onAttach() {
		...
		kRegistration = kontinentEntry.getHeader().addClickHandler(
				new ClickHandler() {
					@Override
		...
		lRegistration = laenderEntry.getHeader().addClickHandler(
				new ClickHandler() {
					@Override
					public void onClick(ClickEvent event) {
		...
		sRegistration = sortenEntry.getHeader().addClickHandler(
				new ClickHandler() {
					@Override
					public void onClick(ClickEvent event) {
