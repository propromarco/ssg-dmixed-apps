...
public class IxGWTStarter {
    ...
    public static void start(final String startupUrl, final String war, final String logdir, final String module, final String server, final boolean headless) {
        try {
            ...
            final Method method = loadClass.getMethod("startup", new Class[] { String[].class, Boolean.class });
            final Object args = new String[] { "-startupUrl", startupUrl, "-war", war, "-logdir", logdir, module, "-server", server };
    ...
    protected static List<URL> createClasspathList() throws MalformedURLException {
            ...
            for (final String classPathEntry : split) {
                ...
                if (split2[split2.length - 1].equals("classes")) {
                    ...
                    }
                    {
                        ...
                        if (srcMainResources.exists() && srcMainResources.isDirectory() && srcMainResources.getAbsolutePath().startsWith(absolutePath)) {
                            urls.add(srcMainResources.toURI().toURL());
                        }
                    }
                    {
    ...
    public static void compileForTest(final String war, final String module) {
        try {
            ...
            final Object args = new String[] { "-style", "PRETTY", "-war", war, "-logLevel", "WARN", module };
