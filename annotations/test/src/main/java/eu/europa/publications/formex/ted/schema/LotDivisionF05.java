...
/**
 * <p>Java class for lot_division_f05 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="lot_division_f05">
 *   &lt;complexContent>
...
@XmlType(name = "lot_division_f05")
public class LotDivisionF05
    extends LotNumbers
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LotDivisionF05)) {
            return false;
        }
        if (this == object) {
            return true;
