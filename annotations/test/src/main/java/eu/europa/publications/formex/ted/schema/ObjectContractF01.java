 ...
 * 
 * <p>Java class for object_contract_f01 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_contract_f01">
 *   &lt;complexContent>
 ...
 *         &lt;choice>
 *           &lt;sequence>
 *             &lt;element name="LOT_DIVISION" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}lot_division_f01"/>
 *             &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f01" maxOccurs="1000"/>
 *           &lt;/sequence>
 *           &lt;sequence>
 *             &lt;element ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}NO_LOT_DIVISION"/>
 *             &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f01"/>
 *           &lt;/sequence>
 *         &lt;/choice>
...
@XmlType(name = "object_contract_f01", propOrder = {
    "title",
    "referencenumber",
    "cpvmain",
    "typecontract",
...
public class ObjectContractF01
    implements Equals, HashCode, ToString
{
    ...
    protected LotDivisionF01 lotdivision;
    @XmlElement(name = "OBJECT_DESCR")
    protected List<ObjectF01> objectdescrs;
     ...
     *     
     */
    public LotDivisionF01 getLOTDIVISION() {
        return lotdivision;
    }
     ...
     *     
     */
    public void setLOTDIVISION(LotDivisionF01 value) {
     ...
     * 
     */
    public List<ObjectF01> getOBJECTDESCRS() {
        if (objectdescrs == null) {
            objectdescrs = new ArrayList<ObjectF01>();
        }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectContractF01)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectContractF01 that = ((ObjectContractF01) object);
        {
            TITLE lhsTITLE;
        ...
        {
            LotDivisionF01 lhsLOTDIVISION;
            lhsLOTDIVISION = this.getLOTDIVISION();
            LotDivisionF01 rhsLOTDIVISION;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<ObjectF01> theOBJECTDESCRS;
