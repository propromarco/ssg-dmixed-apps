 ...
 * 
 * <p>Java class for object_contract_f08 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_contract_f08">
 *   &lt;complexContent>
 ...
 *         &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f08"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "object_contract_f08", propOrder = {
    "title",
    "referencenumber",
    "cpvmain",
    "typecontract",
...
public class ObjectContractF08
    implements Equals, HashCode, ToString
{
    ...
    protected ObjectF08 objectdescr;
     ...
     *     
     */
    public ObjectF08 getOBJECTDESCR() {
        return objectdescr;
    }
     ...
     *     
     */
    public void setOBJECTDESCR(ObjectF08 value) {
        this.objectdescr = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectContractF08)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectContractF08 that = ((ObjectContractF08) object);
        {
            TITLE lhsTITLE;
        ...
        {
            ObjectF08 lhsOBJECTDESCR;
            lhsOBJECTDESCR = this.getOBJECTDESCR();
            ObjectF08 rhsOBJECTDESCR;
