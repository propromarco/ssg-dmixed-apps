...
/**
 * <p>Java class for object_f22 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_f22">
 *   &lt;complexContent>
...
@XmlType(name = "object_f22", propOrder = {
    "title",
    "lotno",
    "cpvadditionals",
    "nuts",
    ...
    implements Equals, HashCode, ToString
{
     ...
     *     
     */
    public void setQS(ObjectF22 .QS value) {
        this.qs = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectF22)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectF22 that = ((ObjectF22) object);
        {
            TITLE lhsTITLE;
        ...
        }
        {
            ...
            ObjectF22 .QS rhsQS;
            rhsQS = that.getQS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "qs", lhsQS), LocatorUtils.property(thatLocator, "qs", rhsQS), lhsQS, rhsQS)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            ObjectF22 .QS theQS;
            theQS = this.getQS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "qs", theQS), currentHashCode, theQS);
        }
        {
            Val theVALOBJECT;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            ObjectF22 .QS theQS;
            theQS = this.getQS();
            strategy.appendField(locator, this, "qs", buffer, theQS);
        }
        {
            Val theVALOBJECT;
            theVALOBJECT = this.getVALOBJECT();
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof ObjectF22 .QS)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final ObjectF22 .QS that = ((ObjectF22 .QS) object);
            {
                XMLGregorianCalendar lhsDATESTART;
                lhsDATESTART = this.getDATESTART();
                XMLGregorianCalendar rhsDATESTART;
