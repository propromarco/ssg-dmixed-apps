...
/**
 * <p>Java class for object_f02 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_f02">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}award_criteria_doc"/>
 *         &lt;element ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}VAL_OBJECT"/>
 *         &lt;group ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}time_frame"/>
 *         &lt;group ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}renewal"/>
 *         &lt;group ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}limit_candidate" minOccurs="0"/>
 *         &lt;group ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}variants"/>
 *         &lt;group ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}options"/>
 *         &lt;element ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}ECATALOGUE_REQUIRED" minOccurs="0"/>
...
@XmlType(name = "object_f02", propOrder = {
    "title",
    "lotno",
    "cpvadditionals",
    "nuts",
    ...
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(name = "VAL_OBJECT", required = true)
    ...
    protected BigInteger nbminlimitcandidate;
    @XmlElement(name = "NB_MAX_LIMIT_CANDIDATE")
    protected BigInteger nbmaxlimitcandidate;
    @XmlElement(name = "NB_ENVISAGED_CANDIDATE")
    protected BigInteger nbenvisagedcandidate;
    @XmlElement(name = "CRITERIA_CANDIDATE")
    protected TextFtMultiLines criteriacandidate;
    @XmlElement(name = "NO_ACCEPTED_VARIANTS")
    protected Empty noacceptedvariants;
    ...
    protected Empty ecataloguerequired;
    ...
    /**
     * Gets the value of the norenewal property.
     * 
     * @return
     *     possible object is
     *     {@link Empty }
     *     
     */
    public Empty getNORENEWAL() {
        return norenewal;
    }

    /**
     * Sets the value of the norenewal property.
     * 
     * @param value
     *     allowed object is
     *     {@link Empty }
     *     
     */
    public void setNORENEWAL(Empty value) {
        this.norenewal = value;
    }
    ...
    /**
     * Gets the value of the nbminlimitcandidate property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getNBMINLIMITCANDIDATE() {
        return nbminlimitcandidate;
    }

    /**
     * Sets the value of the nbminlimitcandidate property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setNBMINLIMITCANDIDATE(BigInteger value) {
        this.nbminlimitcandidate = value;
    }

    /**
     * Gets the value of the nbmaxlimitcandidate property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getNBMAXLIMITCANDIDATE() {
        return nbmaxlimitcandidate;
    }

    /**
     * Sets the value of the nbmaxlimitcandidate property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setNBMAXLIMITCANDIDATE(BigInteger value) {
        this.nbmaxlimitcandidate = value;
    }

    /**
     * Gets the value of the nbenvisagedcandidate property.
     * 
     * @return
     *     possible object is
     *     {@link BigInteger }
     *     
     */
    public BigInteger getNBENVISAGEDCANDIDATE() {
        return nbenvisagedcandidate;
    }

    /**
     * Sets the value of the nbenvisagedcandidate property.
     * 
     * @param value
     *     allowed object is
     *     {@link BigInteger }
     *     
     */
    public void setNBENVISAGEDCANDIDATE(BigInteger value) {
        this.nbenvisagedcandidate = value;
    }

    /**
     * Gets the value of the criteriacandidate property.
     * 
     * @return
     *     possible object is
     *     {@link TextFtMultiLines }
     *     
     */
    public TextFtMultiLines getCRITERIACANDIDATE() {
        return criteriacandidate;
    }

    /**
     * Sets the value of the criteriacandidate property.
     * 
     * @param value
     *     allowed object is
     *     {@link TextFtMultiLines }
     *     
     */
    public void setCRITERIACANDIDATE(TextFtMultiLines value) {
        this.criteriacandidate = value;
    }

    /**
     * Gets the value of the noacceptedvariants property.
     * 
     * @return
     *     possible object is
     *     {@link Empty }
     *     
     */
    public Empty getNOACCEPTEDVARIANTS() {
        return noacceptedvariants;
    }

    /**
     * Sets the value of the noacceptedvariants property.
     * 
     * @param value
     *     allowed object is
     *     {@link Empty }
     *     
     */
    public void setNOACCEPTEDVARIANTS(Empty value) {
        this.noacceptedvariants = value;
    }
    ...
    /**
     * Gets the value of the ecataloguerequired property.
     * 
     * @return
     *     possible object is
     *     {@link Empty }
     *     
     */
    public Empty getECATALOGUEREQUIRED() {
        return ecataloguerequired;
    }

    /**
     * Sets the value of the ecataloguerequired property.
     * 
     * @param value
     *     allowed object is
     *     {@link Empty }
     *     
     */
    public void setECATALOGUEREQUIRED(Empty value) {
        this.ecataloguerequired = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectF02)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectF02 that = ((ObjectF02) object);
        {
            TITLE lhsTITLE;
        ...
        {
            Empty lhsNORENEWAL;
            lhsNORENEWAL = this.getNORENEWAL();
            Empty rhsNORENEWAL;
            rhsNORENEWAL = that.getNORENEWAL();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "norenewal", lhsNORENEWAL), LocatorUtils.property(thatLocator, "norenewal", rhsNORENEWAL), lhsNORENEWAL, rhsNORENEWAL)) {
                return false;
            }
        }
        {
        ...
        {
            BigInteger lhsNBMINLIMITCANDIDATE;
            lhsNBMINLIMITCANDIDATE = this.getNBMINLIMITCANDIDATE();
            BigInteger rhsNBMINLIMITCANDIDATE;
            rhsNBMINLIMITCANDIDATE = that.getNBMINLIMITCANDIDATE();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "nbminlimitcandidate", lhsNBMINLIMITCANDIDATE), LocatorUtils.property(thatLocator, "nbminlimitcandidate", rhsNBMINLIMITCANDIDATE), lhsNBMINLIMITCANDIDATE, rhsNBMINLIMITCANDIDATE)) {
                return false;
            }
        }
        {
            BigInteger lhsNBMAXLIMITCANDIDATE;
            lhsNBMAXLIMITCANDIDATE = this.getNBMAXLIMITCANDIDATE();
            BigInteger rhsNBMAXLIMITCANDIDATE;
            rhsNBMAXLIMITCANDIDATE = that.getNBMAXLIMITCANDIDATE();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "nbmaxlimitcandidate", lhsNBMAXLIMITCANDIDATE), LocatorUtils.property(thatLocator, "nbmaxlimitcandidate", rhsNBMAXLIMITCANDIDATE), lhsNBMAXLIMITCANDIDATE, rhsNBMAXLIMITCANDIDATE)) {
                return false;
            }
        }
        {
            BigInteger lhsNBENVISAGEDCANDIDATE;
            lhsNBENVISAGEDCANDIDATE = this.getNBENVISAGEDCANDIDATE();
            BigInteger rhsNBENVISAGEDCANDIDATE;
            rhsNBENVISAGEDCANDIDATE = that.getNBENVISAGEDCANDIDATE();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "nbenvisagedcandidate", lhsNBENVISAGEDCANDIDATE), LocatorUtils.property(thatLocator, "nbenvisagedcandidate", rhsNBENVISAGEDCANDIDATE), lhsNBENVISAGEDCANDIDATE, rhsNBENVISAGEDCANDIDATE)) {
                return false;
            }
        }
        {
            TextFtMultiLines lhsCRITERIACANDIDATE;
            lhsCRITERIACANDIDATE = this.getCRITERIACANDIDATE();
            TextFtMultiLines rhsCRITERIACANDIDATE;
            rhsCRITERIACANDIDATE = that.getCRITERIACANDIDATE();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "criteriacandidate", lhsCRITERIACANDIDATE), LocatorUtils.property(thatLocator, "criteriacandidate", rhsCRITERIACANDIDATE), lhsCRITERIACANDIDATE, rhsCRITERIACANDIDATE)) {
                return false;
            }
        }
        {
            Empty lhsNOACCEPTEDVARIANTS;
            lhsNOACCEPTEDVARIANTS = this.getNOACCEPTEDVARIANTS();
            Empty rhsNOACCEPTEDVARIANTS;
            rhsNOACCEPTEDVARIANTS = that.getNOACCEPTEDVARIANTS();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "noacceptedvariants", lhsNOACCEPTEDVARIANTS), LocatorUtils.property(thatLocator, "noacceptedvariants", rhsNOACCEPTEDVARIANTS), lhsNOACCEPTEDVARIANTS, rhsNOACCEPTEDVARIANTS)) {
                return false;
            }
        }
        {
        ...
        {
            Empty lhsECATALOGUEREQUIRED;
            lhsECATALOGUEREQUIRED = this.getECATALOGUEREQUIRED();
            Empty rhsECATALOGUEREQUIRED;
            rhsECATALOGUEREQUIRED = that.getECATALOGUEREQUIRED();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "ecataloguerequired", lhsECATALOGUEREQUIRED), LocatorUtils.property(thatLocator, "ecataloguerequired", rhsECATALOGUEREQUIRED), lhsECATALOGUEREQUIRED, rhsECATALOGUEREQUIRED)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            Empty theNORENEWAL;
            theNORENEWAL = this.getNORENEWAL();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "norenewal", theNORENEWAL), currentHashCode, theNORENEWAL);
        }
        {
            Empty theRENEWAL;
        ...
        {
            BigInteger theNBMINLIMITCANDIDATE;
            theNBMINLIMITCANDIDATE = this.getNBMINLIMITCANDIDATE();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "nbminlimitcandidate", theNBMINLIMITCANDIDATE), currentHashCode, theNBMINLIMITCANDIDATE);
        }
        {
            BigInteger theNBMAXLIMITCANDIDATE;
            theNBMAXLIMITCANDIDATE = this.getNBMAXLIMITCANDIDATE();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "nbmaxlimitcandidate", theNBMAXLIMITCANDIDATE), currentHashCode, theNBMAXLIMITCANDIDATE);
        }
        {
            BigInteger theNBENVISAGEDCANDIDATE;
            theNBENVISAGEDCANDIDATE = this.getNBENVISAGEDCANDIDATE();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "nbenvisagedcandidate", theNBENVISAGEDCANDIDATE), currentHashCode, theNBENVISAGEDCANDIDATE);
        }
        {
            TextFtMultiLines theCRITERIACANDIDATE;
            theCRITERIACANDIDATE = this.getCRITERIACANDIDATE();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "criteriacandidate", theCRITERIACANDIDATE), currentHashCode, theCRITERIACANDIDATE);
        }
        {
            Empty theNOACCEPTEDVARIANTS;
            theNOACCEPTEDVARIANTS = this.getNOACCEPTEDVARIANTS();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "noacceptedvariants", theNOACCEPTEDVARIANTS), currentHashCode, theNOACCEPTEDVARIANTS);
        }
        {
        ...
        {
            Empty theECATALOGUEREQUIRED;
            theECATALOGUEREQUIRED = this.getECATALOGUEREQUIRED();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "ecataloguerequired", theECATALOGUEREQUIRED), currentHashCode, theECATALOGUEREQUIRED);
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            Empty theNORENEWAL;
            theNORENEWAL = this.getNORENEWAL();
            strategy.appendField(locator, this, "norenewal", buffer, theNORENEWAL);
        }
        {
            Empty theRENEWAL;
            theRENEWAL = this.getRENEWAL();
        ...
        }
        {
            BigInteger theNBMINLIMITCANDIDATE;
            theNBMINLIMITCANDIDATE = this.getNBMINLIMITCANDIDATE();
            strategy.appendField(locator, this, "nbminlimitcandidate", buffer, theNBMINLIMITCANDIDATE);
        }
        {
            BigInteger theNBMAXLIMITCANDIDATE;
            theNBMAXLIMITCANDIDATE = this.getNBMAXLIMITCANDIDATE();
            strategy.appendField(locator, this, "nbmaxlimitcandidate", buffer, theNBMAXLIMITCANDIDATE);
        }
        {
            BigInteger theNBENVISAGEDCANDIDATE;
            theNBENVISAGEDCANDIDATE = this.getNBENVISAGEDCANDIDATE();
            strategy.appendField(locator, this, "nbenvisagedcandidate", buffer, theNBENVISAGEDCANDIDATE);
        }
        {
            TextFtMultiLines theCRITERIACANDIDATE;
            theCRITERIACANDIDATE = this.getCRITERIACANDIDATE();
            strategy.appendField(locator, this, "criteriacandidate", buffer, theCRITERIACANDIDATE);
        }
        {
            Empty theNOACCEPTEDVARIANTS;
            theNOACCEPTEDVARIANTS = this.getNOACCEPTEDVARIANTS();
            strategy.appendField(locator, this, "noacceptedvariants", buffer, theNOACCEPTEDVARIANTS);
        }
        {
            Empty theACCEPTEDVARIANTS;
            theACCEPTEDVARIANTS = this.getACCEPTEDVARIANTS();
        ...
        }
        {
            Empty theECATALOGUEREQUIRED;
            theECATALOGUEREQUIRED = this.getECATALOGUEREQUIRED();
            strategy.appendField(locator, this, "ecataloguerequired", buffer, theECATALOGUEREQUIRED);
        }
        {
            Empty theNOEUPROGRRELATED;
            theNOEUPROGRRELATED = this.getNOEUPROGRRELATED();
