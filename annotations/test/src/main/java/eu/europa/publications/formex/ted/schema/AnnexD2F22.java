...
/**
 * <p>Java class for annex_d2_f22 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="annex_d2_f22">
 *   &lt;complexContent>
...
@XmlType(name = "annex_d2_f22", propOrder = {
    "doutsidescope",
    "daccordancearticle",
    "djustification"
})
public class AnnexD2F22
    implements Equals, HashCode, ToString
{
    ...
    protected AnnexD2F22 .DACCORDANCEARTICLE daccordancearticle;
     ...
     * @return
     *     possible object is
     *     {@link AnnexD2F22 .DACCORDANCEARTICLE }
     *     
     */
    public AnnexD2F22 .DACCORDANCEARTICLE getDACCORDANCEARTICLE() {
     ...
     *     
     */
    public void setDACCORDANCEARTICLE(AnnexD2F22 .DACCORDANCEARTICLE value) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AnnexD2F22)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AnnexD2F22 that = ((AnnexD2F22) object);
        {
        ...
        {
            AnnexD2F22 .DACCORDANCEARTICLE lhsDACCORDANCEARTICLE;
            lhsDACCORDANCEARTICLE = this.getDACCORDANCEARTICLE();
            AnnexD2F22 .DACCORDANCEARTICLE rhsDACCORDANCEARTICLE;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            AnnexD2F22 .DACCORDANCEARTICLE theDACCORDANCEARTICLE;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof AnnexD2F22 .DACCORDANCEARTICLE)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final AnnexD2F22 .DACCORDANCEARTICLE that = ((AnnexD2F22 .DACCORDANCEARTICLE) object);
            {
