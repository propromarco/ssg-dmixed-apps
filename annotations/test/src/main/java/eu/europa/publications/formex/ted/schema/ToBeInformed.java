...
/**
 * <p>Java class for to_be_informed complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="to_be_informed">
 *   &lt;complexContent>
 ...
 *       &lt;attribute name="CONTRACTING_BODY" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}yes_no" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "to_be_informed")
@XmlSeeAlso({
    eu.europa.publications.formex.ted.schema.Sender.NOTIFICATION.TECHNICAL.class
})
    ...
    implements Equals, HashCode, ToString
{
    ...
    @XmlAttribute(name = "CONTRACTING_BODY")
    protected YesNo contractingbody;
     ...
     *     
     */
    public YesNo getCONTRACTINGBODY() {
     ...
     *     
     */
    public void setCONTRACTINGBODY(YesNo value) {
        this.contractingbody = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ToBeInformed)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ToBeInformed that = ((ToBeInformed) object);
        {
            YesNo lhsESENDER;
        ...
        {
            YesNo lhsCONTRACTINGBODY;
            lhsCONTRACTINGBODY = this.getCONTRACTINGBODY();
            YesNo rhsCONTRACTINGBODY;
