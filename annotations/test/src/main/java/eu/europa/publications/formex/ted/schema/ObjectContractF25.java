 ...
 * 
 * <p>Java class for object_contract_f25 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_contract_f25">
 *   &lt;complexContent>
 ...
 *         &lt;element name="TYPE_CONTRACT" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}no_supplies"/>
 ...
 *         &lt;element name="CALCULATION_METHOD" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}text_ft_multi_lines" minOccurs="0"/>
 *         &lt;choice>
 ...
 *             &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f25" maxOccurs="1000"/>
 *           &lt;/sequence>
 *           &lt;sequence>
 *             &lt;element ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}NO_LOT_DIVISION"/>
 *             &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f25"/>
 *           &lt;/sequence>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
...
@XmlType(name = "object_contract_f25", propOrder = {
    "title",
    "referencenumber",
    "cpvmain",
    "typecontract",
...
public class ObjectContractF25
    implements Equals, HashCode, ToString
{
    ...
    protected DREPETITIONEXISTING typecontract;
    ...
    protected TextFtMultiLines calculationmethod;
    ...
    protected List<ObjectF25> objectdescrs;
     ...
     *     
     */
    public DREPETITIONEXISTING getTYPECONTRACT() {
        return typecontract;
    }
     ...
     *     
     */
    public void setTYPECONTRACT(DREPETITIONEXISTING value) {
     ...
     *     
     */
    public TextFtMultiLines getCALCULATIONMETHOD() {
     ...
     *     
     */
    public void setCALCULATIONMETHOD(TextFtMultiLines value) {
     ...
     * 
     */
    public List<ObjectF25> getOBJECTDESCRS() {
        if (objectdescrs == null) {
            objectdescrs = new ArrayList<ObjectF25>();
        }
        return this.objectdescrs;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectContractF25)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectContractF25 that = ((ObjectContractF25) object);
        {
            TITLE lhsTITLE;
        ...
        {
            DREPETITIONEXISTING lhsTYPECONTRACT;
            lhsTYPECONTRACT = this.getTYPECONTRACT();
            DREPETITIONEXISTING rhsTYPECONTRACT;
        ...
        {
            TextFtMultiLines lhsCALCULATIONMETHOD;
            lhsCALCULATIONMETHOD = this.getCALCULATIONMETHOD();
            TextFtMultiLines rhsCALCULATIONMETHOD;
            rhsCALCULATIONMETHOD = that.getCALCULATIONMETHOD();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "calculationmethod", lhsCALCULATIONMETHOD), LocatorUtils.property(thatLocator, "calculationmethod", rhsCALCULATIONMETHOD), lhsCALCULATIONMETHOD, rhsCALCULATIONMETHOD)) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            DREPETITIONEXISTING theTYPECONTRACT;
        ...
        {
            TextFtMultiLines theCALCULATIONMETHOD;
            theCALCULATIONMETHOD = this.getCALCULATIONMETHOD();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "calculationmethod", theCALCULATIONMETHOD), currentHashCode, theCALCULATIONMETHOD);
        }
        {
        ...
        {
            List<ObjectF25> theOBJECTDESCRS;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        }
        {
            TextFtMultiLines theCALCULATIONMETHOD;
            theCALCULATIONMETHOD = this.getCALCULATIONMETHOD();
            strategy.appendField(locator, this, "calculationmethod", buffer, theCALCULATIONMETHOD);
        }
        {
            ValRange theVALRANGETOTAL;
            theVALRANGETOTAL = this.getVALRANGETOTAL();
