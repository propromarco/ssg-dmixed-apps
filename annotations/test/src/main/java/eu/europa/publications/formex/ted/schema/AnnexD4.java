...
/**
 * <p>Java class for annex_d4 complex type.
 * 
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201423EU.PTAWARDCONTRACTWITHOUTPUBLICATION.DACCORDANCEARTICLE daccordancearticle;
     ...
     * @return
     *     possible object is
     *     {@link eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201423EU.PTAWARDCONTRACTWITHOUTPUBLICATION.DACCORDANCEARTICLE }
     *     
     */
    public eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201423EU.PTAWARDCONTRACTWITHOUTPUBLICATION.DACCORDANCEARTICLE getDACCORDANCEARTICLE() {
     ...
     *     
     */
    public void setDACCORDANCEARTICLE(eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201423EU.PTAWARDCONTRACTWITHOUTPUBLICATION.DACCORDANCEARTICLE value) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AnnexD4)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AnnexD4 that = ((AnnexD4) object);
        {
        ...
        {
            eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201423EU.PTAWARDCONTRACTWITHOUTPUBLICATION.DACCORDANCEARTICLE lhsDACCORDANCEARTICLE;
            lhsDACCORDANCEARTICLE = this.getDACCORDANCEARTICLE();
            eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201423EU.PTAWARDCONTRACTWITHOUTPUBLICATION.DACCORDANCEARTICLE rhsDACCORDANCEARTICLE;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201423EU.PTAWARDCONTRACTWITHOUTPUBLICATION.DACCORDANCEARTICLE theDACCORDANCEARTICLE;
