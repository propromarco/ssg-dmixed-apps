...
/**
 * <p>Java class for object_f06 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_f06">
 *   &lt;complexContent>
...
@XmlType(name = "object_f06", propOrder = {
    "title",
    "lotno",
    "cpvadditionals",
    "nuts",
    ...
    implements Equals, HashCode, ToString
{
     ...
     *     
     */
    public void setAC(ObjectF06 .AC value) {
        this.ac = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectF06)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectF06 that = ((ObjectF06) object);
        {
            TITLE lhsTITLE;
        ...
        implements Equals, HashCode, ToString
    {
        ...
        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof ObjectF06 .AC)) {
                return false;
            }
            if (this == object) {
                return true;
            ...
            final ObjectF06 .AC that = ((ObjectF06 .AC) object);
            {
