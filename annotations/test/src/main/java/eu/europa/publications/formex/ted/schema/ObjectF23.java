...
/**
 * <p>Java class for object_f23 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_f23">
 *   &lt;complexContent>
...
@XmlType(name = "object_f23", propOrder = {
    "title",
    "lotno",
    "cpvadditionals",
    "nuts",
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectF23)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectF23 that = ((ObjectF23) object);
        {
            TITLE lhsTITLE;
