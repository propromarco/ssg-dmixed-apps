...
@XmlType(name = "supplies")
@XmlRootElement(name = "D_COMMODITY_MARKET")
public class DCOMMODITYMARKET
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DCOMMODITYMARKET)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DCOMMODITYMARKET that = ((DCOMMODITYMARKET) object);
        {
            String lhsCTYPE;
