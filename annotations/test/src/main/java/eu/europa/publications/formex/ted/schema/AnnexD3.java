...
/**
 * <p>Java class for annex_d3 complex type.
 * 
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE200981EC.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE daccordancearticle;
     ...
     * @return
     *     possible object is
     *     {@link eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE200981EC.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE }
     *     
     */
    public eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE200981EC.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE getDACCORDANCEARTICLE() {
     ...
     *     
     */
    public void setDACCORDANCEARTICLE(eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE200981EC.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE value) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AnnexD3)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AnnexD3 that = ((AnnexD3) object);
        {
        ...
        {
            eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE200981EC.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE lhsDACCORDANCEARTICLE;
            lhsDACCORDANCEARTICLE = this.getDACCORDANCEARTICLE();
            eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE200981EC.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE rhsDACCORDANCEARTICLE;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE200981EC.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE theDACCORDANCEARTICLE;
