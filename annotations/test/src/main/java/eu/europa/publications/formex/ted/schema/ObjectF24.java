...
/**
 * <p>Java class for object_f24 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_f24">
 *   &lt;complexContent>
 ...
 *         &lt;choice>
 *           &lt;element ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}AC_PROCUREMENT_DOC"/>
...
@XmlType(name = "object_f24", propOrder = {
    "title",
    "lotno",
    "cpvadditionals",
    "nuts",
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectF24)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectF24 that = ((ObjectF24) object);
        {
            TITLE lhsTITLE;
