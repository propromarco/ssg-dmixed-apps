 ...
 * 
 * <p>Java class for object_contract_f07 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_contract_f07">
 *   &lt;complexContent>
 ...
 *         &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f07"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "object_contract_f07", propOrder = {
    "title",
    "referencenumber",
    "cpvmain",
    "typecontract",
...
public class ObjectContractF07
    implements Equals, HashCode, ToString
{
    ...
    protected ObjectF07 objectdescr;
     ...
     *     
     */
    public ObjectF07 getOBJECTDESCR() {
        return objectdescr;
    }
     ...
     *     
     */
    public void setOBJECTDESCR(ObjectF07 value) {
        this.objectdescr = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectContractF07)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectContractF07 that = ((ObjectContractF07) object);
        {
            TITLE lhsTITLE;
        ...
        {
            ObjectF07 lhsOBJECTDESCR;
            lhsOBJECTDESCR = this.getOBJECTDESCR();
            ObjectF07 rhsOBJECTDESCR;
