 ...
 * Section II: OBJECT
 * 
 * <p>Java class for object_contract_f13 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_contract_f13">
 *   &lt;complexContent>
 ...
 *         &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f13"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "object_contract_f13", propOrder = {
    "title",
    "referencenumber",
    "cpvmain",
    "objectdescr"
})
public class ObjectContractF13
    implements Equals, HashCode, ToString
{
    ...
    protected ObjectF13 objectdescr;
     ...
     *     
     */
    public ObjectF13 getOBJECTDESCR() {
        return objectdescr;
    }
     ...
     *     
     */
    public void setOBJECTDESCR(ObjectF13 value) {
        this.objectdescr = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectContractF13)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectContractF13 that = ((ObjectContractF13) object);
        {
            TITLE lhsTITLE;
        ...
        {
            ObjectF13 lhsOBJECTDESCR;
            lhsOBJECTDESCR = this.getOBJECTDESCR();
            ObjectF13 rhsOBJECTDESCR;
