 ...
 * 
 * <p>Java class for object_contract_f02 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_contract_f02">
 *   &lt;complexContent>
 ...
 *         &lt;choice>
 *           &lt;sequence>
 *             &lt;element name="LOT_DIVISION" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}lot_division_f02"/>
 *             &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f02" maxOccurs="1000"/>
 *           &lt;/sequence>
 *           &lt;sequence>
 *             &lt;element ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}NO_LOT_DIVISION"/>
 *             &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f02"/>
 *           &lt;/sequence>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
...
@XmlType(name = "object_contract_f02", propOrder = {
    "title",
    "referencenumber",
    "cpvmain",
    "typecontract",
...
public class ObjectContractF02
    implements Equals, HashCode, ToString
{
    ...
    protected LotDivisionF02 lotdivision;
    @XmlElement(name = "OBJECT_DESCR")
    protected List<ObjectF02> objectdescrs;
     ...
     *     
     */
    public LotDivisionF02 getLOTDIVISION() {
        return lotdivision;
    }
     ...
     *     
     */
    public void setLOTDIVISION(LotDivisionF02 value) {
     ...
     * 
     */
    public List<ObjectF02> getOBJECTDESCRS() {
        if (objectdescrs == null) {
            objectdescrs = new ArrayList<ObjectF02>();
        }
        return this.objectdescrs;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectContractF02)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectContractF02 that = ((ObjectContractF02) object);
        {
            TITLE lhsTITLE;
        ...
        {
            LotDivisionF02 lhsLOTDIVISION;
            lhsLOTDIVISION = this.getLOTDIVISION();
            LotDivisionF02 rhsLOTDIVISION;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<ObjectF02> theOBJECTDESCRS;
