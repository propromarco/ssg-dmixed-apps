 ...
 * 
 * <p>Java class for object_contract_f24 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_contract_f24">
 *   &lt;complexContent>
 ...
 *         &lt;choice>
 *           &lt;sequence>
 *             &lt;element name="LOT_DIVISION" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}lot_division_f24"/>
 *             &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f24" maxOccurs="1000"/>
 *           &lt;/sequence>
 *           &lt;sequence>
 *             &lt;element ref="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}NO_LOT_DIVISION"/>
 *             &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f24"/>
 *           &lt;/sequence>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
...
@XmlType(name = "object_contract_f24", propOrder = {
    "title",
    "referencenumber",
    "cpvmain",
    "typecontract",
...
public class ObjectContractF24
    implements Equals, HashCode, ToString
{
    ...
    protected LotDivisionF24 lotdivision;
    @XmlElement(name = "OBJECT_DESCR")
    protected List<ObjectF24> objectdescrs;
     ...
     *     
     */
    public LotDivisionF24 getLOTDIVISION() {
        return lotdivision;
    }
     ...
     *     
     */
    public void setLOTDIVISION(LotDivisionF24 value) {
     ...
     * 
     */
    public List<ObjectF24> getOBJECTDESCRS() {
        if (objectdescrs == null) {
            objectdescrs = new ArrayList<ObjectF24>();
        }
        return this.objectdescrs;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectContractF24)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectContractF24 that = ((ObjectContractF24) object);
        {
            TITLE lhsTITLE;
        ...
        {
            LotDivisionF24 lhsLOTDIVISION;
            lhsLOTDIVISION = this.getLOTDIVISION();
            LotDivisionF24 rhsLOTDIVISION;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<ObjectF24> theOBJECTDESCRS;
