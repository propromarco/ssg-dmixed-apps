...
/**
 * <p>Java class for no_supplies complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="no_supplies">
 *   &lt;complexContent>
...
@XmlType(name = "no_supplies")
@XmlRootElement(name = "D_REPETITION_EXISTING")
public class DREPETITIONEXISTING
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DREPETITIONEXISTING)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DREPETITIONEXISTING that = ((DREPETITIONEXISTING) object);
        {
            String lhsCTYPE;
