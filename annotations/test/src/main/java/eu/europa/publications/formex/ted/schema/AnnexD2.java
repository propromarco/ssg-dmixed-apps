...
/**
 * <p>Java class for annex_d2 complex type.
 * 
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201425EU.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE daccordancearticle;
     ...
     * @return
     *     possible object is
     *     {@link eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201425EU.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE }
     *     
     */
    public eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201425EU.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE getDACCORDANCEARTICLE() {
     ...
     *     
     */
    public void setDACCORDANCEARTICLE(eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201425EU.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE value) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AnnexD2)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AnnexD2 that = ((AnnexD2) object);
        {
        ...
        {
            eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201425EU.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE lhsDACCORDANCEARTICLE;
            lhsDACCORDANCEARTICLE = this.getDACCORDANCEARTICLE();
            eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201425EU.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE rhsDACCORDANCEARTICLE;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            eu.europa.publications.formex.ted.schema.ProcedureF15 .DIRECTIVE201425EU.PTNEGOTIATEDWITHOUTPUBLICATION.DACCORDANCEARTICLE theDACCORDANCEARTICLE;
