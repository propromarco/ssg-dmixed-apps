...
/**
 * <p>Java class for object_f20 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_f20">
 *   &lt;complexContent>
...
@XmlType(name = "object_f20", propOrder = {
    "title",
    "lotno",
    "cpvadditionals",
    "nuts",
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectF20)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectF20 that = ((ObjectF20) object);
        {
            TITLE lhsTITLE;
