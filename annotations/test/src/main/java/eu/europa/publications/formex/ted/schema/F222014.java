 ...
 * ROOT element F22
 * 
 * <p>Java class for F22_2014 element declaration.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;element name="F22_2014">
 *   &lt;complexType>
 *     &lt;complexContent>
 *       &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *         &lt;sequence>
 *           &lt;element name="NOTICE" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}notice_f22"/>
 *           &lt;element name="CONTRACTING_BODY" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}body_f22"/>
 *           &lt;element name="OBJECT_CONTRACT" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_contract_f22" maxOccurs="100"/>
 *           &lt;element name="LEFTI" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}lefti_f22" minOccurs="0"/>
 *           &lt;element name="PROCEDURE" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}procedure_f22" minOccurs="0"/>
 *           &lt;element name="AWARD_CONTRACT" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}award_contract_f22" maxOccurs="1000" minOccurs="0"/>
 *           &lt;element name="COMPLEMENTARY_INFO" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}ci_f22"/>
 *         &lt;/sequence>
 ...
 *         &lt;attribute name="FORM" use="required" type="{http://www.w3.org/2001/XMLSchema}anySimpleType" fixed="F22" />
 *       &lt;/restriction>
 *     &lt;/complexContent>
 *   &lt;/complexType>
 * &lt;/element>
...
@XmlRootElement(name = "F22_2014")
public class F222014
    implements TEDFormular, Equals, HashCode, ToString
{

    @XmlElement(name = "NOTICE", required = true)
    protected NoticeF22 notice;
    @XmlElement(name = "CONTRACTING_BODY", required = true)
    protected BodyF22 contractingbody;
    @XmlElement(name = "OBJECT_CONTRACT", required = true)
    protected List<ObjectContractF22> objectcontracts;
    @XmlElement(name = "LEFTI")
    protected LeftiF22 lefti;
    @XmlElement(name = "PROCEDURE")
    protected ProcedureF22 procedure;
    @XmlElement(name = "AWARD_CONTRACT")
    protected List<AwardContractF22> awardcontracts;
    @XmlElement(name = "COMPLEMENTARY_INFO", required = true)
    protected CiF22 complementaryinfo;
     ...
     *     
     */
    public void setNOTICE(NoticeF22 value) {
        this.notice = value;
    }
     ...
     *     
     */
    public BodyF22 getCONTRACTINGBODY() {
     ...
     *     
     */
    public void setCONTRACTINGBODY(BodyF22 value) {
     ...
     * {@link ObjectContractF22 }
     * 
     * 
     */
    public List<ObjectContractF22> getOBJECTCONTRACTS() {
        if (objectcontracts == null) {
            objectcontracts = new ArrayList<ObjectContractF22>();
        }
     ...
     *     
     */
    public void setLEFTI(LeftiF22 value) {
        this.lefti = value;
    }
     ...
     *     
     */
    public ProcedureF22 getPROCEDURE() {
        return procedure;
    }
     ...
     *     
     */
    public void setPROCEDURE(ProcedureF22 value) {
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AwardContractF22 }
     * 
     * 
     */
    public List<AwardContractF22> getAWARDCONTRACTS() {
        if (awardcontracts == null) {
            awardcontracts = new ArrayList<AwardContractF22>();
        }
     ...
     *     
     */
    public CiF22 getCOMPLEMENTARYINFO() {
     ...
     *     
     */
    public void setCOMPLEMENTARYINFO(CiF22 value) {
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof F222014)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final F222014 that = ((F222014) object);
        {
            NoticeF22 lhsNOTICE;
        ...
        {
            BodyF22 lhsCONTRACTINGBODY;
            lhsCONTRACTINGBODY = this.getCONTRACTINGBODY();
            BodyF22 rhsCONTRACTINGBODY;
        ...
        {
            ProcedureF22 lhsPROCEDURE;
            lhsPROCEDURE = this.getPROCEDURE();
            ProcedureF22 rhsPROCEDURE;
        ...
        {
            CiF22 lhsCOMPLEMENTARYINFO;
            lhsCOMPLEMENTARYINFO = this.getCOMPLEMENTARYINFO();
            CiF22 rhsCOMPLEMENTARYINFO;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        {
            List<ObjectContractF22> theOBJECTCONTRACTS;
        ...
        {
            List<AwardContractF22> theAWARDCONTRACTS;
