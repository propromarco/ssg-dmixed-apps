...
/**
 * <p>Java class for non_published complex type.
 * 
...
@XmlSeeAlso({
    eu.europa.publications.formex.ted.schema.AwardContractF06 .AWARDEDCONTRACT.COUNTRYORIGIN.class
})
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof NonPublished)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final NonPublished that = ((NonPublished) object);
        {
