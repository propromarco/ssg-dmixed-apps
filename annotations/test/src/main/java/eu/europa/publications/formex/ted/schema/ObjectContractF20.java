 ...
 * 
 * <p>Java class for object_contract_f20 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_contract_f20">
 *   &lt;complexContent>
 ...
 *         &lt;element name="OBJECT_DESCR" type="{http://formex.publications.europa.eu/ted/schema/reception/R2.0.9.S01}object_f20"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "object_contract_f20", propOrder = {
    "title",
    "referencenumber",
    "cpvmain",
    "typecontract",
...
public class ObjectContractF20
    implements Equals, HashCode, ToString
{
    ...
    protected ObjectF20 objectdescr;
     ...
     *     
     */
    public ObjectF20 getOBJECTDESCR() {
        return objectdescr;
    }
     ...
     *     
     */
    public void setOBJECTDESCR(ObjectF20 value) {
        this.objectdescr = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectContractF20)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectContractF20 that = ((ObjectContractF20) object);
        {
            TITLE lhsTITLE;
        ...
        {
            ObjectF20 lhsOBJECTDESCR;
            lhsOBJECTDESCR = this.getOBJECTDESCR();
            ObjectF20 rhsOBJECTDESCR;
