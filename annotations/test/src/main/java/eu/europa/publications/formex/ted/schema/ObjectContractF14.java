 ...
 * 
 * <p>Java class for object_contract_f14 complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="object_contract_f14">
 *   &lt;complexContent>
...
@XmlType(name = "object_contract_f14", propOrder = {
    "title",
    "referencenumber",
    "cpvmain",
    "typecontract",
...
public class ObjectContractF14
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ObjectContractF14)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ObjectContractF14 that = ((ObjectContractF14) object);
        {
            TITLE lhsTITLE;
