...
public class GWTStarter
{
    ...
    {
        start(startupUrl, war, logdir, module, "com.appspot.ssg.dmixed.MyJettyLauncher", headless);
    }
...
//                    }
        ...
        {
            Logger.getLogger(GWTStarter.class.getName()).finest(url.toString());
        }
        return urls;
    }
